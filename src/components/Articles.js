                ...
                <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-2 xl:space-x-5 xl:max-w-7xl">
                    ...
                    <div className="flex bg-gray-900 text-white rounded-lg py-3">
                        <div className="flex flex-col items-start px-4">
                            ...
                            <a className="leading-none rounded font-medium text-green-600 text-sm " 
                            href="https://adeleyemahmud.com/2022/03/25/add-a-web3-connect-button-to-your-react-app-with-typescript-and-metamask/">Read</a>
